...
{{< image src="images/post/01_blog_caret_Tut_files/figure-html/unnamed-chunk-17-1.png" caption="This is Image Caption" alt="alter-text" command="fill" option="q95" class="img-fluid" title="image title" >}}<!-- -->
