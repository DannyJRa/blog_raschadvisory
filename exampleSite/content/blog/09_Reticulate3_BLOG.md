...
{{< image src="images/post/09_Reticulate3_BLOG_files/figure-html/unnamed-chunk-4-1.png" caption="This is Image Caption" alt="alter-text" command="fill" option="q95" class="img-fluid" title="image title" >}}<!-- -->
